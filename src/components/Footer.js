...
function Footer() {
  return (
    <>
    <footer className="bg-[#0b1523] pt-45 pb-16 px-5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-5 gap-10 text-sm text-gray-400">
          <div className="flex gap-4">
            <i
              className="fa-solid text-white fa-location-dot pt-1"
